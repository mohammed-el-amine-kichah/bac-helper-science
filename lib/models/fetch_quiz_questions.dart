...
QuizManager quizManager = QuizManager([
  ...
  Quiz('مصطلحات التاريخ', [
    Unit('الوحدة الأولى', [
      ...
      Question(
          "احتلال دولة بغرض استغلالها سياسيا واقتصاديا وبشريا واستراتيجيا ونهب ثرواتها، باستخدام القوة والحملات العسكرية",
          [
            Answer("الاستعمار التقليدي", true),
            Answer("الاستعمار المقنع", false),
            Answer("التحرر السياسي", false),
          ]),
      Question(
          "شكل من أشكال الاستعمار غير المباشر، تستعمل فيه الوسائل الاقتصادية والثقافية كالاتفاقيات ووسائل الإعلام",
          [
            Answer("الاستعمار المقنع", true),
            Answer("الاستعمار التقليدي", false),
            Answer("التحرر الشامل", false),
          ]),
      Question(
          "التخلص من الوجود الاستعماري وقيام حكومة وطنية معترف بها دوليا", [
        Answer("التحرر السياسي", true),
        Answer("التحرر الشامل", false),
        Answer("الكومنولث", false),
      ]),
      Question(
          "استكمال الاستقلال السياسي بالاستقلال الاقتصادي، بحيث تتحكم الدولة في جميع ثرواتها، بما يضمن لها السيادة التامة داخليا وخارجيا",
          [
            Answer("التحرر الشامل", true),
            Answer("التحرر السياسي", false),
            Answer("الفرانكفونية", false),
          ]),
      Question(
          "منظمة تأسست سنة 1931، وهي مجموعة المستعمرات البريطانية القديمة والناطقة بالإنجليزية وعددها 54 دولة",
          [
            Answer("الكومنولث COMMONWEALTH", true),
            Answer("الفرانكفونية FRANCOPHONE", false),
            Answer("اتفاقيات الاستقلال", false),
          ]),
      Question(
          "منظمة تأسست في 20 مارس 1970 تحت اسم 'وكالة التعاون الثقافي والفني'، تحول اسمها 1995، وهي مجموعة المستعمرات الناطقة باللغة الفرنسية وعددها 68 دولة",
          [
            Answer("الفرانكفونية FRANCOPHONE", true),
            Answer("الكومنولث COMMONWEALTH", false),
            Answer("التبعية", false),
          ]),
      Question(
          "المعاهدات التي تم توقيعها بين الدولة المستعمرة والقوى التحررية في دولة ما",
          [
            Answer("اتفاقيات الاستقلال", true),
            Answer("التبعية", false),
            Answer("الاستقرار السياسي", false),
          ]),
      Question(
          "ارتباط دولة بدولة أخرى سياسيا، اقتصاديا وثقافيا، إما بسبب معاهدات أو ضعف النظام أو تحكم الشركات الأجنبية في اقتصادها، وتمثل امتدادا استعماريا",
          [
            Answer("التبعية", true),
            Answer("الاستقرار السياسي", false),
            Answer("التمييز العنصري", false),
          ]),
      Question(
          "حالة سياسية تتميز بها الدول الكبرى نتيجة استقرار مؤسسات الحكم والتزامها بالديمقراطية، عكس الدول المتخلفة التي تعاني عدم الاستقرار نتيجة كثرة الصراعات على السلطة",
          [
            Answer("الاستقرار السياسي", true),
            Answer("التمييز العنصري", false),
            Answer("الدكتاتورية", false),
          ]),
      Question(
          "سياسة استعمارية تقوم على أساس التمييز والتفضيل بسبب العرق أو اللون أو الأصل",
          [
            Answer("التمييز العنصري", true),
            Answer("الدكتاتورية", false),
            Answer("الديمقراطية", false),
          ]),
      Question(
          "شكل من أشكال الحكم تكون فيه السلطة مطلقة في يد الفرد الواحد، لا يتقيد بدستور أو قوانين، ويعمل على تقييد الحريات الأساسية ويتميز بالتسلط والاستبداد",
          [
            Answer("الدكتاتورية", true),
            Answer("الديمقراطية", false),
            Answer("الأنظمة الفردية", false),
          ]),
      Question("شكل من أشكال الحكم تكون فيه السلطة بيد الشعب الذي يقرر مصيره", [
        Answer("الديمقراطية", true),
        Answer("الدكتاتورية", false),
        Answer("الأنظمة الفردية", false),
      ]),
      Question("فرض نظام سياسي ذو طابع عسكري من طرف فرد أو جماعة معينة", [
        Answer("الأنظمة الفردية", true),
        Answer("الحروب الأهلية", false),
        Answer("الحدود الموروثة", false),
      ]),
      Question(
          "حرب تقع داخل حدود البلد الواحد بين شعب واحد بسبب الخلافات والاختلافات",
          [
            Answer("الحروب الأهلية", true),
            Answer("الحدود الموروثة", false),
            Answer("المنظمات اليهودية", false),
          ]),
      Question(
          "الحدود التي خلفها الاستعمار للدول المستقلة ما يتسبب في الحروب بين دول الجوار",
          [
            Answer("الحدود الموروثة", true),
            Answer("المنظمات اليهودية", false),
            Answer("الحكم الذاتي", false),
          ]),
      Question(
          "منظمات داعمة للحركة الصهيونية والتي عملت على تهويد فلسطين أي تحويلها لوطن قومي لليهود، يديرها المؤتمر اليهودي العالمي، وهو اتحاد دولي للمنظمات اليهودية في أكثر من 70 دولة",
          [
            Answer("المنظمات اليهودية", true),
            Answer("الحكم الذاتي", false),
            Answer("المكاتب العربية", false),
          ]),
      Question(
          "استقلال داخلي عن الدولة المستعمرة، ويبقى الأمن والسياسة الخارجية في يد المستعمر",
          [
            Answer("الحكم الذاتي", true),
            Answer("المكاتب العربية", false),
            Answer("المحتشدات", false),
          ]),
      Question(
          "جهاز إداري خاص أنشأه الاستعمار منذ احتلاله الجزائر كأداة للإحصاء والتجسس، ثم أصبحت تسمى 'المصالح الإدارية المختصة SAS'، شكلها 'سوستيل' للضغط على الثورة",
          [
            Answer("المكاتب العربية", true),
            Answer("المحتشدات", false),
            Answer("المناطق المحرمة", false),
          ]),
      Question(
          "مراكز مسيجة ومغلقة ومحروسة، استعملتها فرنسا لعزل الشعب عن الثورة", [
        Answer("المحتشدات", true),
        Answer("المناطق المحرمة", false),
        Answer("النابالم", false),
      ]),
      Question(
          "مناطق اعتبرتها فرنسا خطيرة لتواجد المجاهدين بها 1958، فمنعت الإقامة بها وغيرها",
          [
            Answer("المناطق المحرمة", true),
            Answer("النابالم", false),
            Answer("القوة الثالثة", false),
          ]),
      Question(
          "قنابل نارية حارقة محرمة دوليا، استعملها الاستعمار الفرنسي في الجزائر",
          [
            Answer("النابالم", true),
            Answer("القوة الثالثة", false),
            Answer("الأقدام السوداء", false),
          ]),
      Question(
          "فئة عميلة موالية لفرنسا، والتي دعمتها لضرب الثورة وتغليط الرأي العام العالمي",
          [
            Answer("القوة الثالثة", true),
            Answer("الأقدام السوداء", false),
            Answer("سلم الشجعان", false),
          ]),
      Question(
          "الفرنسيون المولودون في الجزائر والذين يعتبرون أنفسهم أصحاب الحق فيها",
          [
            Answer("الأقدام السوداء", true),
            Answer("سلم الشجعان", false),
            Answer("حرب العصابات", false),
          ]),
      Question(
          "مشروع ومناورة سياسية جاء بها 'شارل ديغول' في 23 أكتوبر 1958، يقضي باستسلام الثوار وتقديم أسلحتهم للبدء في التحاور مع فرنسا، مقابل ضمان حريتهم وحقوقهم",
          [
            Answer("سلم الشجعان", true),
            Answer("حرب العصابات", false),
            Answer("المسبلون", false),
          ]),
      Question("أي القيام بعمليات محدودة وتجنب المواجهة المباشرة مع العدو", [
        Answer("حرب العصابات", true),
        Answer("المسبلون", false),
        Answer("منظمة الجيش السري OAS", false),
      ]),
      Question(
          "المواطنون المدنيون الذين قدموا خدمات ثانوية سياسية أو إدارية لصالح الثورة",
          [
            Answer("المسبلون", true),
            Answer("منظمة الجيش السري OAS", false),
            Answer("المحافل الدولية", false),
          ]),
      Question(
          "تنظيم إرهابي سري أسسه المستوطنون وبعض القادة الفرنسيين في الجزائر، قامت بعد أعمال تخريبية لتعطيل المفاوضات وكمحاولة يائسة لبقاء الجزائر فرنسية",
          [
            Answer("منظمة الجيش السري OAS", true),
            Answer("المحافل الدولية", false),
            Answer("الإمدادات", false),
          ]),
      Question(
          "مختلف المنظمات والهيئات الدولية، مثل: هيئة الأمم المتحدة، منظمة الوحدة الإفريقية...",
          [
            Answer("المحافل الدولية", true),
            Answer("الإمدادات", false),
            Answer("المخططات الإنمائية", false),
          ]),
      Question(
          "جلب المساعدات والأسلحة والذخيرة من الخارج عبر الحدود والسفن لتموين الثورة",
          [
            Answer("الإمدادات", true),
            Answer("المخططات الإنمائية", false),
            Answer("الثورة الصناعية", false),
          ]),
      Question(
          "برامج تنموية اقتصادية واجتماعية وثقافية قامت بها الجزائر المستقلة لتطوير الاقتصاد الوطني والخروج من التخلف والتبعية (المخطط الثلاثي، الرباعي 1و2، الخماسي 1و2)",
          [
            Answer("المخططات الإنمائية", true),
            Answer("الثورة الصناعية", false),
            Answer("الثورة الزراعية", false),
          ]),
      Question(
          "إرساء قاعدة صناعية في الجزائر تركز على الصناعات الثقيلة (الحديد والصلب...)",
          [
            Answer("الثورة الصناعية", true),
            Answer("الثورة الزراعية", false),
            Answer("الثورة الثقافية", false),
          ]),
      Question(
          "إصلاحات جذرية أدخلتها الجزائر على القطاع الزراعي 1972 تحت شعار 'الأرض لمن يخدمها'، بهدف النهوض بالقطاع وتحقيق الاكتفاء الذاتي وتطوير الريف (التوازن الجهوي)",
          [
            Answer("الثورة الزراعية", true),
            Answer("الثورة الثقافية", false),
            Answer("نظام اقتصادي عالمي جديد", false),
          ]),
    ])
    // Add more quiz types here if needed
  ]),
  Quiz('مصطلحات الجغرافيا', [
    Unit('الوحدة الأولى', [
      Question(
          "مصطلح اقتصادي يدل على وضعية اقتصادية متدهورة، تنعكس على الحياة الاجتماعية والثقافية، وذلك بالاعتماد على الموارد والقدرات الذاتية والتكنولوجيا",
          [
            Answer("التقدم", true),
            Answer("التخلف", false),
            Answer("العالم المتقدم", false),
          ]),
      Question(
          "مصطلح اقتصادي يدل على تدهور الحالة الاقتصادية و تدني المستوى المعيشي، بسبب سوء استعمال الطاقات البشرية والمادية المتاحة",
          [
            Answer("التخلف", true),
            Answer("التقدم", false),
            Answer("تبييض الأموال", false),
          ]),
      Question(
          "مجموعة الدول المتطورة في كل الميادين والتي تقع بين دائرتي 30° شمالا و 35° شمالا في أوروبا وآسيا، يضاف إليها أستراليا، نيوزيلندا وجنوب إفريقيا الواقعة في الجنوب",
          [
            Answer("العالم المتقدم", true),
            Answer("اتفاقية لومي", false),
            Answer("مجموعة التبادل الحر ALENA", false),
          ]),
      Question(
          "جريمة اقتصادية يتم فيها تحويل أموال مكتسبة بطرق غير شرعية (مخدرات، تهريب...) إلى أموال شرعية عبر عمليات بنكية وتجارية",
          [
            Answer("تبييض الأموال", true),
            Answer("التنمية", false),
            Answer("المؤشر", false),
          ]),
      Question(
          "اتفاقية موقعة سنة 1975 بين الاتحاد الأوروبي و 46 دولة من إفريقيا ومنطقتي البحر الكاريبي والمحيط الهادي، وهي تمنح للصادرات الإفريقية إلى الاتحاد الأوروبي إعفاء من الرسوم الجمركية",
          [
            Answer("اتفاقية لومي", true),
            Answer("مجموعة التبادل الحر ALENA", false),
            Answer("التنمية", false),
          ]),
      Question(
          "اتفاقية تجمع اليوم، وكندا والمكسيك، تقضي بنزع الرسوم الجمركية بين هذه الدول بداية من 1994، وذلك لتعزيز التبادل التجاري بينها",
          [
            Answer("مجموعة التبادل الحر ALENA", true),
            Answer("اتفاقية لومي", false),
            Answer("المؤشر", false),
          ]),
      Question(
          ...
          [
            Answer("التنمية", true),
            Answer("المعيار", false),
            Answer("رؤوس الأموال", false),
          ]),
      Question(
          "رقم إحصائي يمثل ظاهرة اجتماعية أو اقتصادية أو ديمغرافية خلال فترة زمنية محددة، وهو وسيلة لتقييم الواقع والمستقبل وإصدار حكم بالإيجاب أو السلب",
          [
            Answer("المؤشر", true),
            Answer("المعيار", false),
            Answer("الاستثمارات", false),
          ]),
      Question(
          "معطيات قياسية لضبط مواصفات موحدة لظاهرة ما، وهو كذلك قيمة أو إشارة رقمية تسمح بتقييم حالة أو وضعية اقتصادية معينة",
          [
            Answer("المعيار", true),
            Answer("المؤشر", false),
            Answer("رؤوس الأموال", false),
      ...
      Question(
          "الموارد المالية المختلفة الثابتة (المصانع، الأراضي،...) والمنقولة (الأموال...) التي تستثمر في المشاريع المختلفة لضمان الإنتاج",
          [
            Answer("رؤوس الأموال", true),
            Answer("الاستثمارات", false),
            Answer("البورصة", false),
          ]),
      Question(
          "مجموع الأموال المنفقة بغرض إنماء رأس المال، أي توظيف المال في مشاريع مربحة تعود على صاحبها بالفائدة",
          [
            Answer("الاستثمارات", true),
            Answer("البورصة", false),
            Answer("البنوك", false),
          ]),
      Question(
          "سوق مالية منظمة تخضع لقانون السوق، يتم فيها تداول العملات والسندات والأسهم وتحديد أسعار المواد الأولية المختلفة",
          [
            Answer("البورصة", true),
            Answer("البنوك", false),
            Answer("الاستثمارات", false),
      ...
      Question(
          "مؤسسات مالية مختصة في استثمار الأموال وتشغيلها وإقراضها إلى المستثمرين مقابل فوائد معتبرة",
          [
            Answer("البنوك", true),
            Answer("البورصة", false),
            Answer("رؤوس الأموال", false),
      ...
      Question(
          "ضعف القدرة الشرائية للعملة ينتج عنه ارتفاع كبير في الأسعار دون ارتفاع في الإنتاج",
          [
            Answer("التضخم", true),
            Answer("القدرة الشرائية", false),
            Answer("مؤشر التنمية البشرية", false),
          ]),
      Question("قدرة المستهلك على شراء السلع والخدمات اللازمة له بنظير دخله", [
        Answer("القدرة الشرائية", true),
        Answer("التضخم", false),
        Answer("الناتج الداخلي الخام", false),
      ]),
      Question(
          "مقياس تأليفي تتراوح قيمته بين 0-1 يعتبر لقياس درجة تقدم الدول، يتألف من أمل الحياة عند الولادة، نسبة التمدرس والدخل الفردي",
          [
            Answer("مؤشر التنمية البشرية", true),
            Answer("أمل الحياة عند الولادة", false),
            Answer("الناتج الداخلي الخام", false),
          ]),
      Question(
          "عدد السنوات التي يتوقع أن يعيشها المواليد في كل فئة في سنة القياس", [
        Answer("أمل الحياة عند الولادة", true),
        Answer("مؤشر التنمية البشرية", false),
        Answer("الزيادة الطبيعية", false),
      ]),
      Question(
          "قيمة ما تنتجه مختلف القطاعات الاقتصادية داخل البلد الواحد خلال سنة",
          [
            Answer("الناتج الداخلي الخام (الدخل المحلي الخام)", true),
            Answer("الناتج الداخلي الخام الفردي (الدخل الفردي)", false),
            Answer("الناتج الوطني الخام", false),
          ]),
      Question(
          "حاصل قسمة الناتج الداخلي الخام على عدد السكان، وهو مقياس نسبي ويكون إما مرتفعا أو منخفضا حسب تغيرات عدد السكان أو الناتج الداخلي الخام",
          [
            Answer("الناتج الداخلي الخام الفردي (الدخل الفردي)", true),
            Answer("الناتج الداخلي الخام", false),
            Answer("الناتج الوطني الخام", false),
          ]),
      Question(
          "جملة الدخل الذي تحققه عوامل الإنتاج بالبلد إضافة إلى المداخيل الخارجية",
          [
            Answer("الناتج الوطني الخام", true),
            Answer("الناتج الداخلي الخام", false),
            Answer("الناتج الداخلي الخام الفردي", false),
          ]),
      Question(
          "أعلى درجات التطور العلمي، والمقصود بها علو التقنيات المطبقة في مختلف المجالات",
          [
            Answer("تكنولوجيا", true),
            Answer("انترنت", false),
            Answer("التجارة الإلكترونية", false),
          ]),
      Question(
          "شبكة حاسوبية عالمية تتكون من شبكات أصغر، بحيث يمكن لأي شخص متصل بها أن يتجول في هذه الشبكة وأن يحصل على المعلومات",
          [
            Answer("انترنت", true),
            Answer("تكنولوجيا", false),
            Answer("التجارة الإلكترونية", false),
          ]),
      Question("الاقتصاد الرقمي، أي البيع والشراء عن طريق شبكة الانترنت", [
        Answer("التجارة الإلكترونية", true),
        Answer("انترنت", false),
        Answer("مستوى المعيشة", false),
      ]),
      Question(
          "تعبير عن الأحوال المعيشية الجارية على الأفراد في المجتمع، يكون إما راقيا أو متدنيا",
          [
            Answer("مستوى المعيشة", true),
            Answer("الزيادة الطبيعية", false),
            Answer("الميزان التجاري", false),
          ]),
      Question("الفرق بين نسبة الولادات والوفيات خلال سنة", [
        Answer("الزيادة الطبيعية", true),
        Answer("مستوى المعيشة", false),
        Answer("الميزان التجاري", false),
      ]),
      Question(
          "الفرق بين قيمة الصادرات والواردات خلال سنة، قد يكون رابحا، عاجزا أو متوازنا",
          [
            Answer("الميزان التجاري", true),
            Answer("ميزان المدفوعات", false),
            Answer("البنية التحتية", false),
          ]),
      Question(
          "كشف حساب لكل السلع والخدمات والاستثمارات التي تتدفق على بلد خلال سنة",
          [
            Answer("ميزان المدفوعات", true),
            Answer("الميزان التجاري", false),
            Answer("المديونية", false),
          ]),
      Question(
          "جملة الهياكل القاعدية، جملة التجهيزات الضرورية لتنشيط الحركة الاقتصادية (الطرقات...)",
          [
            Answer("البنية التحتية", true),
            Answer("ميزان المدفوعات", false),
            Answer("المديونية", false),
          ]),
      Question(
          "قيام دولة بالاقتراض من المؤسسات المالية، ما يترتب عنه تراكم الفوائد في حالة عجزها عن تسديد الديون وهو ما ينتج عنه عواقب اقتصادية",
          [
            Answer("المديونية", true),
            Answer("الكارتل", false),
            Answer("هولدينغ", false),
          ]),
      Question(
          "تجمع لعدة مؤسسات تنتج مادة واحدة للتحكم في الأسعار والحفاظ على المصالح المشتركة بينهم، مع الحفاظ على الاستقلال الإداري والمالي",
          [
            Answer("الكارتل", true),
            Answer("هولدينغ", false),
            Answer("حرية التجارة", false),
          ]),
      Question(
          "مؤسسة تتحكم أو تدير مؤسسات أخرى لأنها تملك أصول مالية وأسهم في رأسمال الشركة",
          [
            Answer("هولدينغ", true),
            Answer("الكارتل", false),
            Answer("حرية التجارة", false),
      ...
      Question(
          "إزالة الحواجز والقيود التي تحد من تدفق التجارة الدولية ومنع احتكارها",
          [
            Answer("حرية التجارة", true),
            Answer("هجرة الأدمغة", false),
            Answer("التأميم", false),
          ]),
      Question(
          "حركة مغادرة الكفاءات العلمية والتقنية والباحثين لأوطانهم باتجاه العالم المتقدم",
          [
            Answer("هجرة الأدمغة", true),
            Answer("حرية التجارة", false),
            Answer("التأميم", false),
          ]),
      Question(
          "نقل الملكية من الفرد إلى الدولة أو الجماعة الوطنية، أي الملكية العامة لوسائل الإنتاج",
          [
            Answer("التأميم", true),
            Answer("هجرة الأدمغة", false),
            Answer("حرية التجارة", false),
      ...
      Question(
          "عبارة أطلقت على الولايات الجنوبية والغربية للو.م.أ نظرا للحرارة العالية والحركة الاقتصادية المرتكزة على التكنولوجيات المتقدمة",
          [
            Answer("حزام الشمس", true),
            Answer("مجموعة الثمانية", false),
            Answer("الآسيان", false),
          ]),
      Question(
          "الدول الأكثر تصنيعا في العالم، بدأ تشكل المجموعة في اجتماع دعت إليه فرنسا 1975 حضرته ألمانيا، إيطاليا، بريطانيا، الو.م.أ، كندا واليابان، انضمت بهم روسيا في التسعينات، تعقد هذه المجموعة اجتماعات دورية كل سنة لبحث قضايا سياسية واقتصادية وأمنية",
          [
            Answer("مجموعة الثمانية", true),
            Answer("الآسيان", false),
            Answer("النمور", false),
          ]),
      Question(
          "تكتل دول جنوب شرق آسيا 1967 لترقية الموارد الأولية والفلاحية والتنمية الاقتصادية، يضم دول التيغور، سنغافورة، بروناي، الفيتنام، لاوس، كمبوديا وبورمانيا (ميانمار)",
          [
            Answer("الآسيان", true),
            Answer("النمور", false),
            Answer("التنينات", false),
          ]),
      Question(
          "تسمية أطلقت على اقتصاديات ماليزيا، إندونيسيا، الفلبين وتايلاندا، نظرا للتطور الملموس و'القفزة' التي حققتها اقتصاديا",
          [
            Answer("النمور", true),
            Answer("التنينات", false),
            Answer("القطب الاقتصادي", false),
          ]),
      Question(
          "تسمية أطلقت على اقتصاديات هونغ كونغ، سنغافورة، تايوان وكوريا الجنوبية، والتي شهدت 'نموا' اقتصاديا سريعا في العشريتين الأخيرتين",
          [
            Answer("التنينات", true),
            Answer("النمور", false),
            Answer("الوزن الديمغرافي", false),
          ]),
      Question(
          "زيادة كمية تسجلها المنتجات والخدمات في بلد، وتقاس بمؤشرات أهمها الناتج الوطني",
          [
            Answer("النمو الاقتصادي", true),
            Answer("الوزن الديمغرافي", false),
            Answer("القطب الاقتصادي", false),
          ]),
      Question(
          "القوة البشرية المعتبرة التي تشكل عامل قوة للدول التي تمتلك تعداد سكاني كبير وتحسن استثماره وتوظيفه في عملية الإنتاج والتنمية",
          [
            Answer("الوزن الديمغرافي", true),
            Answer("النمو الاقتصادي", false),
            Answer("القطب الاقتصادي", false),
          ]),
      Question(
          "منطقة تمثل قوة اقتصادية مؤثرة فاعلة في الاقتصاد العالمي، من خلال قدرتها على جذب رؤوس الأموال، اليد العاملة والتكنولوجيا",
          [
            Answer("القطب الاقتصادي", true),
            Answer("القطب التكنولوجي", false),
            Answer("مجمع مدن (ميغابوليس)", false),
          ]),
      Question(
          "مدينة تنتج التكنولوجيا وتروج التقنيات المتطورة وتستقطب العلماء والباحثين",
          [
            Answer("القطب التكنولوجي", true),
            Answer("مجمع مدن (ميغابوليس)", false),
            Answer("قوى اقتصادية كبرى (الثالوث المتقدم)", false),
          ]),
      Question(
          "تجمع حضري ضخم يتكون من عدة مدن كبرى متجاورة، تتميز بنشاط اقتصادي متعدد ووفرة خطوط المواصلات بينها",
          [
            Answer("مجمع مدن (ميغابوليس)", true),
            Answer("القطب التكنولوجي", false),
            Answer("قوى اقتصادية كبرى (الثالوث المتقدم)", false),
          ]),
      Question(
          "هي المجموعات الاقتصادية الكبرى أو الدول المتقدمة التي تشكل فيما بينها مركز اقتصادي عالمي، وتشمل: الو.م.أ، أوروبا، اليابان",
          [
            Answer("قوى اقتصادية كبرى (الثالوث المتقدم)", true),
            Answer("مجمع مدن (ميغابوليس)", false),
            Answer("تقسيم دولي للعمل", false),
          ]),
      Question(
          "توزيع إجمالي للأدوار، بحيث تقوم الدول المتخلفة بتصدير خامات الموارد الأولية، بينما تقوم الدول المتقدمة بتحويلها إلى مواد مصنعة وتصديرها",
          [
            Answer("تقسيم دولي للعمل", true),
            Answer("قوى اقتصادية كبرى (الثالوث المتقدم)", false),
            Answer("الموارد الطبيعية", false),
          ]),
      Question(
          "الثروات السطحية والباطنية مثل المعادن، البترول، التربة والغابات، وتتشكل بتأثير العوامل الطبيعية وبشكل تلقائي دون تدخل الإنسان فيها، ويمكن أن تتحول إلى ثروة فعلية بأي صورة من الصور إما على هيئة سلع أو خدمات أو غيرها",
          [
            Answer("الموارد الطبيعية", true),
            Answer("الموارد المتجددة", false),
            Answer("تقسيم دولي للعمل", false),
          ]),
      Question(
          "الموارد التي تتجدد بصفة مستمرة ولا تتعرض للزوال، مثل الطاقة الشمسية",
          [
            Answer("الموارد المتجددة", true),
            Answer("الموارد الطبيعية", false),
            Answer("تقسيم دولي للعمل", false),
          ]),
    ])
